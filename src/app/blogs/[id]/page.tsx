        ...
        <div className="sm:p-8 p-4">
            ...
            <div className="flex flex-col gap-y-[2px] sm:p-16 container max-w-[1880px]">
                ...
                <div className="sm:flex sm:border-4 border-red-300 sm:p-2">
                    <Image src={post.image} alt="health" width={600} height={200} className="rounded shadow-md shadow-red-300 sm:shadow-none" />

                    {/* Post Info */}
                    <div className="px-2">
                        <div className="flex items-center justify-between border-b-4 sm:border-none py-4">
                            <p className="text-xs text-gray-500 bg-green-200 p-[4px] rounded-lg mt-[6px]"><i className="fas fa-user text-xs mr-1"></i>{post.author}</p>
                ...
                {/* Post Content */}
                <div className="p-2 space-y-2 sm:space-y-6">
                    <p className="sm:text-xl">{post.content}</p>
                    <p className="sm:text-xl">{post.content}</p>
                    <p className="sm:text-xl">{post.content}</p>
                    <p className="sm:text-xl">{post.content}</p>
                </div>
